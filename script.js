...
// PERSISTENCE (Specific to Car Brands)
let lifetimeScore = parseInt(localStorage.getItem('carBrandsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedCarLessons')) || [];
if(ptsVal) ptsVal.innerText = lifetimeScore;

let wordBucket = []; let currentQ = 0; let attempts = 0; let totalScore = 0; let firstCard = null;

// STATIONS (Matching your GitHub screenshot exactly)
const stations = [
    {file:"01_AlfaRomeo.mp3", title:"Alfa Romeo"},
    {file:"02_AstonMartin.mp3", title:"Aston Martin"},
    {file:"03_Audi.mp3", title:"Audi"},
    {file:"04_BMW.mp3", title:"BMW"},
    {file:"05_Cadillac.mp3", title:"Cadillac"},
    {file:"06_Chevrolet.mp3", title:"Chevrolet"},
    {file:"07_Citroen.mp3", title:"Citroën"},
    {file:"08_Ferrari.mp3", title:"Ferrari"},
    {file:"09_Ford.mp3", title:"Ford"},
    {file:"10_Honda.mp3", title:"Honda"},
    {file:"11_Jaguar.mp3", title:"Jaguar"},
    {file:"12_Lamborghini.mp3", title:"Lamborghini"},
    {file:"13_Mazda.mp3", title:"Mazda"},
    {file:"14_MercedesBenz.mp3", title:"Mercedes-Benz"},
    {file:"15_Nissan.mp3", title:"Nissan"},
    {file:"16_Porsche.mp3", title:"Porsche"},
    {file:"17_Subaru.mp3", title:"Subaru"},
    {file:"18_Suzuki.mp3", title:"Suzuki"},
    {file:"19_Tesla.mp3", title:"Tesla"},
    {file:"20_Toyota.mp3", title:"Toyota"},
    {file:"21_Volkswagen.mp3", title:"Volkswagen"}
];
...
// BOWLING QUIZ LOGIC (With Hard-Reset Mic Logic)
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('carBrandsScore', lifetimeScore);
    const fn = audio.src.split('/').pop();
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedCarLessons', JSON.stringify(completedLessons));
    }
